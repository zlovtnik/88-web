  ...
  template: `
    <div class="financial-records-container">
      <div class="header">
        ...
        <p>Manage tax returns and financial documents</p>
      </div>
      
      <div class="content">
        <mat-card>
          <mat-card-header>
            <mat-card-title>Tax Returns</mat-card-title>
            <mat-card-subtitle>View and manage tax return records</mat-card-subtitle>
          </mat-card-header>
          <mat-card-content>
